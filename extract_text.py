...
import re # importing regular expressions module for text cleaning
...
if __name__ == "__main__":
    ...
    else: #returns an error message if the command line arguments are not valid -> this is the case when arguments are less than 2 or greater than 3
        print("Usage:")
